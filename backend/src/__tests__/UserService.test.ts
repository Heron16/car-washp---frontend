...
const mockFindOne = UsuarioModel.findOne as jest.Mock;
const mockFindByPk = UsuarioModel.findByPk as jest.Mock;
const mockCreate = UsuarioModel.create as jest.Mock;
const mockUpdate = UsuarioModel.update as jest.Mock;
