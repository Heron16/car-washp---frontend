...
const mockCreate = ServicoModel.create as jest.Mock;
const mockFindAndCountAll = ServicoModel.findAndCountAll as jest.Mock;
const mockFindByPk = ServicoModel.findByPk as jest.Mock;
