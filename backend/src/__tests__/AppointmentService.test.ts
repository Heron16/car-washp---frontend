...
jest.mock('../models/ServicoModel', () => ({
  ServicoModel: { findByPk: jest.fn() },
}));
...
jest.mock('../models/VeiculoModel', () => ({ VeiculoModel: {} }));
jest.mock('../models/UsuarioModel', () => ({ UsuarioModel: {} }));

import { ServicoModel } from '../models/ServicoModel';
import { AgendamentoModel } from '../models/AgendamentoModel';

const mockServiceFindByPk = ServicoModel.findByPk as jest.Mock;
const mockAptFindAll = AgendamentoModel.findAll as jest.Mock;
const mockAptFindOne = AgendamentoModel.findOne as jest.Mock;
const mockAptCreate = AgendamentoModel.create as jest.Mock;
