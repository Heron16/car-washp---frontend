...
const mockFindOne = VeiculoModel.findOne as jest.Mock;
const mockCreate = VeiculoModel.create as jest.Mock;
const mockFindAndCountAll = VeiculoModel.findAndCountAll as jest.Mock;
